...
describe('addMicroStx', () => {
  it('adds multiple amounts', () => {
    expect(addMicroStx(BigInt(100), BigInt(200), BigInt(300))).toBe(BigInt(600));
  });
...
describe('subtractMicroStx', () => {
  it('subtracts amounts', () => {
    expect(subtractMicroStx(BigInt(500), BigInt(200), BigInt(100))).toBe(BigInt(200));
  });
});
...
describe('maxMicroStx', () => {
  it('returns the maximum amount', () => {
    expect(maxMicroStx(BigInt(100), BigInt(300), BigInt(200))).toBe(BigInt(300));
  });
...
describe('minMicroStx', () => {
  it('returns the minimum amount', () => {
    expect(minMicroStx(BigInt(100), BigInt(300), BigInt(200))).toBe(BigInt(100));
  });
